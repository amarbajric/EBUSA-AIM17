...
@Component({
  selector: 'ngx-processmodel-configure',
  templateUrl: './processmodel-configure.component.html',
  styleUrls: ['./processmodel-configure.component.scss'],
})

export class ProcessModelConfigureComponent implements OnInit {
  processModel;
  rules;
  error = undefined;
  formBuilder;
