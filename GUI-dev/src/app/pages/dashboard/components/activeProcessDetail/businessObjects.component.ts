    ...
    <div *ngFor="let field of businessObject.fields">
      ...
      <div class="form-group">
        <div [ngSwitch]="field.type">
          ...
          <input type="text" *ngSwitchCase="'STRING'" class="form-control" id="{{field.id}}" 
                 ...
                 [attr.required]="field.required" [readonly]="field.readonly">
          <input type="number" *ngSwitchCase="'number'" class="form-control" id="{{field.id}}" 
                 name="{{businessObject.bomId}}-:_{{field.bofmId}}" [ngModel]="field.value" 
          ...
          <div class="row" *ngSwitchCase="'radio'">
            <div class="col-sm-1" *ngFor="let choice of field.choices">
              ...
              <input type="radio" [disabled]="field.readonly" [ngModelOptions]="{standalone: true}" 
                     [(ngModel)]="field.value" [value]="choice.name" [checked]="choice.name === field.value"/>
...
export class BusinessObjectsComponent {
